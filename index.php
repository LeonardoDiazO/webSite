...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" integrity="sha512-8wEtY2eh0wCfrGKw64HPW7sL5qwxEDJB1rS9ZWsYRVFXBN3mzxIh9mRZM52Q3IYffpwpm/PsRhUyhJUcq7Yryg==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    </head>
    <body id="page-top">
        <!-- Navigation-->
        ...
        <section class="page-section" id="about">
            <div class="container">
                ...
                <ul class="timeline">
                    <?php
                    $contador=1;
                    foreach ($lista_entrada as $registros) { 
                        ?>
